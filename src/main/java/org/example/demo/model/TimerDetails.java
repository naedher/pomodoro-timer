...
public class TimerDetails {
    ...
    public TimerDetails(Long id, String name, LocalDateTime createdAt, LocalDateTime updatedAt, Integer workDuration, Integer breakDuration, Integer pomodoroCount) {
        this.id = id;
        this.name = name;
